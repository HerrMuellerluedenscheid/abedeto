...
def get_bounds(
    stations, events=None, usestations=False, printall=False, show_fig=False, km=False
):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Find minimum and maximum distances/depth."
    )
    parser.add_argument(
        "--markers",
    ...
    parser.add_argument(
        "--stations", help="name of file containing station information", required=True
    )
    parser.add_argument(
        "--events",
